...
function() {
    ...
    b = function(t) {
        if (!k.ie || k.ie > 10) {
            ...
            if (o) {
                ...
                var i = o.document;
                i.open(),
                i.write('<meta http-equiv="refresh" content="0; url=' + y.DOM.encode(t) + '">'),
                i.close()
            }
        }
        var r, a
    ...
    w = function(t, e) {
        ...
        return (r = e ? (n = a(n = r)).length ? n.concat(i) : i: a(r)).length ? (o = r, _.trim(o.sort().join(" "))) : null
    },
    T = function(t, e) {
        return e = e || t.selection.getNode(),
    ...
    O = function(t, e) {
        var n, o; (o = t.dom.select("img", e)[0]) && (n = t.dom.getParents(o, "a[href]", e)[0]) && (n.parentNode.insertBefore(o, n), t.dom.remove(n))
    },
    N = function(t, e, n) {
        var o, i; (i = t.dom.select("img", e)[0]) && (o = t.dom.create("a", n), i.parentNode.insertBefore(o, i), o.appendChild(i))
    },
    R = function(t, e) {
        return function(n) {
            t.undoManager.transact(function() {
                ...
                v(t.settings) || !1 !== p(t.settings) || (r.rel = w(r.rel, "_blank" === r.target)),
                n.href === e.href && (e.attach(), e = {}),
                i ? (t.focus(), n.hasOwnProperty("text") && ("innerText" in i ? i.innerText = n.text: i.textContent = n.text), t.dom.setAttribs(i, r), t.selection.select(i), t.undoManager.add()) : M(o) ? N(t, o, r) : n.hasOwnProperty("text") ? t.insertContent(t.dom.createHTML("a", r, t.dom.encode(n.text))) : t.execCommand("mceInsertLink", !1, r)
            })
        }
    },
    A = function(t) {
    ...
    q = function(t, e, n) {
        ...
        D.setEditorTimeout(t,
        function() {
            t.windowManager.confirm(e,
            function(e) {
    ...
    V = function(t, e) {
        var n, o, i, a, l, y, k, b, w, T, C, M = {},
        O = t.selection,
        N = t.dom,
        L = function(t) {
            var e = i.find("#text"); (!e.value() || t.lastControl && e.value() === t.lastControl.text()) && e.value(t.control.text()),
            i.find("#href").value(t.control.value())
        },
        P = function() {
            o || !a || M.text || this.parent().parent().find("#text")[0].value(this.value())
        };
        a = E(O.getContent()),
        n = K(t),
        M.text = o = S(t.selection, n),
        M.href = n ? N.getAttrib(n, "href") : "",
        n ? M.target = N.getAttrib(n, "target") : u(t.settings) && (M.target = c(t.settings)),
        ...
        d(t.settings) && (s(t.settings) === undefined && f(t, [{
            text: "None",
            value: ""
        },
        {
        ...
        v(t.settings) && (k = {
            ...
            type: "listbox",
            label: "Rel",
            values: F(m(t.settings),
            function(e) { ! 1 === p(t.settings) && (e.value = U(e.value, "_blank" === M.target))
            })
        }),
        h(t.settings) && (w = {
            name: "class",
        ...
        i = t.windowManager.open({
            ...
            body: [{
                ...
                onchange: function(e) {
                    ...
                    function(t, e) {
                        var n = i.find("#" + e);
                        "text" === e ? 0 === o.length && (n.value(t), M.text = t) : n.value(t)
                    }),
                    n.attach && (B = {
                        href: this.value(),
                        attach: n.attach
            ...
            function(e) {
                var n = [];
                if (_.each(t.dom.select("a:not([href])"),
                function(t) {
                    var o = t.name || t.id;
                    o && n.push({
                        text: o,
            ...
            onSubmit: function(e) {
                ...
                M, e.data),
                c = u.href;
                c ? (a && u.text !== o || delete u.text, c.indexOf("@") > 0 && -1 === c.indexOf("//") && -1 === c.indexOf("mailto:") ? q(t, "The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?",
                function(t) {
                    t && (u.href = "mailto:" + c),
                    i(u)
                }) : !0 === n && !/^\w+:/i.test(c) || !1 === n && /^\s*www[\.|\d\.]/i.test(c) ? q(t, "The URL you entered seems to be an external link. Do you want to add the required http:// prefix?",
                function(t) {
                    t && (u.href = "http://" + c),
                    i(u)
                }) : i(u)) : l()
    ...
    z = function(t) {
        var e, n, o;
        n = V,
        "string" == typeof(o = l((e = t).settings)) ? I.send({
            url: o,
            success: function(t) {
                n(e, JSON.parse(t))
            }
    ...
    X = function(t) {
        return function(e) {
            var n, o, i, r;
            return !! (a(t.settings) && (!(r = t.plugins.contextmenu) || !r.isContextMenuVisible()) && L(e) && 3 === (i = (o = (n = t.selection).getRng()).startContainer).nodeType && n.isCollapsed() && o.startOffset > 0 && o.startOffset < i.data.length)
        }
    },
    Q = function(t) {
        t.on("click",
        ...
        function(e) {
            var n, o = J(t);
            o && 13 === e.keyCode && !0 === (n = e).altKey && !1 === n.shiftKey && !1 === n.ctrlKey && !1 === n.metaKey && (e.preventDefault(), $(t, o))
        })
    },
    W = function(t) {
        return function() {
